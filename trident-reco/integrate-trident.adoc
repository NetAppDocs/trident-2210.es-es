...
=== Cloud Volumes Service con controladores de back-end para GCP
...
. *CVS-Performance*: Tipo de servicio optimizado para el rendimiento que se adapta mejor a las cargas de trabajo de producción que valoran el rendimiento. Elija entre tres niveles de servicio exclusivos [`standard`, `premium`, y. `extreme`].


El tamaño mínimo de volumen CVS y CVS-Performance es de 100 GIB.
...
== Diseño del pool de almacenamiento virtual
